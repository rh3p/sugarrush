...
import PromotionImg from '../../assets/pro.png'
    ...
    <section className='promotion_section'>
        <Container>
            <Row className='align-items-center'>
                <Col lg={6} className='"text-center mb5 mb-lg-0'>
                    <img src={PromotionImg} className='image-fluid' alt='Promotion'/>
                </Col>
                <Col lg={6} className='px-5'>
                <h2>Nothing brings people together like a good cake
                </h2>
